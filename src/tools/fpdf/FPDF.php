...
*******************************************************************************/
namespace PHPMaster88\document\tools\FPDF;
class FPDF{
	const VERSION = '1.85';
	...
	*******************************************************************************/
	...
	function __construct($orientation='P', $unit='mm', $size='A4')
	{
		...
		// Font path
		if(defined('PHPMaster88_FONTPATH'))
		{
			$this->fontpath = PHPMaster88_FONTPATH;
		...
		// Metadata
		$this->metadata = array('Producer'=>'PHPMaster88 '.self::VERSION);
	...
	{
		// Fatal error
		throw new Exception('PHPMaster88 error: '.$msg);
	}
